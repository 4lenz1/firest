#############################################################################
# Makefile for building: firest
# Generated by qmake (3.0) (Qt 5.4.0)
# Project:  firest.pro
# Template: app
# Command: C:\Qt\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ -o Makefile firest.pro
#############################################################################
...
Makefile: firest.pro ../../Qt/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf ../../Qt/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
